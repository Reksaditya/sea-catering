...
export default function MealPlanSection() {
  ...
  return (
    <section className="bg-secondary w-full flex flex-col items-center text-center px-5 py-5 md:px-20 lg:px-32 gap-10">
      <div className="text-white">
        <h1 className="font-bold text-2xl md:text-4xl uppercase mt-10">Choose a plan <br /> <span className="text-primary">that fits</span> your <span className="text-primary">lifestyle</span></h1>
        <h2 className="text-sm md:text-lg mt-3">Smart planning made simple — crafted by experts, designed for real life</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center text-center gap-14">
